import { DummyData, trainModel, createMLModel } from "../TensorflowJS/tensorflowmethods";
import { OPTIMIZERS } from "../TensorflowJS/optimisers";
...
export function TF() {
    ...
    const [model, setModel] = useState(createMLModel(modelOptions));
    ...
    useEffect(() => {
      setTarget(0);
      setPrediction("0");
      setModel(createMLModel    (modelOptions));
    }, [modelOptions]);
